...
I downloaded over 900 Instagram videos using a **third-party scraping service** to avoid rate limits and account blocks, and transcribed them using Azure Speech API with Indonesian language support. Around 700 videos were successfully transcribed. The remaining videos were music-only, ambient, or too noisy.

---
title: "Unlocking Social Media: How I Turned 900+ Instagram Videos into an AI Search Engine"
date: "2025-11-03"
excerpt: "How I discovered that the hardest part of building an AI chatbot isn't the AI-it's turning 900+ messy Instagram videos into clean, structured data that the AI can actually use."
...
The first challenge was getting the data. Instagram has aggressive rate limits, and downloading hundreds of videos manually or with simple scripts often leads to account blocks.

To bypass these restrictions reliably, I integrated a **third-party scraping service**. This allowed me to safely and efficiently extract over 900 Instagram videos without dealing with the constant headache of cookie rotation or IP bans.

Once downloaded, each video was sent to **Azure Speech API** with Indonesian language support for transcription. Out of the 900+ videos, around 700 were successfully transcribed. The remaining videos were music-only clips, ambient noise, or audio too noisy for reliable transcription.

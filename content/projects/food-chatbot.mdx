...
I downloaded 637 Instagram videos (implementing **cookie rotation with 3+ accounts** to avoid rate limits-random delays and retry logic were essential) and transcribed them using Azure Speech API with Indonesian language support. Success rate: 78% (500/637 videos). The remaining 22% were music-only, ambient, or too noisy.
...
| Metric | Value |
|--------|-------|
| Instagram posts processed | 637 |
| Videos successfully transcribed | 500 (78%) |
...
**Data Engineering Is the Hard Part** - Building the chatbot UI took days. Building the ETL pipeline that turned 637 messy Instagram posts into 900+ clean, structured restaurant profiles with standardized categories took weeks. In AI systems, the model is rarely the bottleneck-the data quality is.
